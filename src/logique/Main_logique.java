...
public class Main_logique implements IParams {
	...
	public static void main(String[] args) {
		...
		Case[][] map = new Case[dimCol][dimLigne];
		int[] tabColor = {RED, BLUE, GREEN, GREEN, WHITE, GREEN, BLUE, GREEN, GREEN, GREEN, GREEN, BLUE, BLUE, 
		...
		Carte carte = new Carte(map, depart, arrive);
